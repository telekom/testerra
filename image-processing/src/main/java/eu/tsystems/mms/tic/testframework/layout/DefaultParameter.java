...
public class DefaultParameter {
    ...
    public static final int LAYOUTCHECK_INTERNAL_PARAMETER_1 = 5;
    public static final int LAYOUTCHECK_INTERNAL_PARAMETER_2 = 10;
    public static final double LAYOUTCHECK_INTERNAL_PARAMETER_3 = 0.51d;
    public static final double LAYOUTCHECK_INTERNAL_PARAMETER_4 = 14;
}