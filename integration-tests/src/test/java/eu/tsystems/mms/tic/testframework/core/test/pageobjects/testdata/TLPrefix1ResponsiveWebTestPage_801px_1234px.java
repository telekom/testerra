 ...
 * of 456px.
 */
public class TLPrefix1ResponsiveWebTestPage_801px_1234px extends PrefixResponsiveWebTestPage {
    /**
     * Constructor for existing sessions.
     *
     * @param driver The web driver.
     */
    public TLPrefix1ResponsiveWebTestPage_801px_1234px(WebDriver driver) {
        super(driver);
    }
}
