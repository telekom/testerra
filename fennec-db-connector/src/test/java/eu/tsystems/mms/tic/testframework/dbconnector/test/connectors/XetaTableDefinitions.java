 ...
 */
public class fennecTableDefinitions extends Table {

    /** Instance of table fennecTestTable. */
    public static final fennecTableDefinitions TESTTABLE = new fennecTestTable("testtable");
    /** Instance of LOBTable. */
    public static final fennecTableDefinitions LOBTABLE = new LobTable("largeobjects");
     ...
     *            Name of the table.
     */
    public fennecTableDefinitions(final String table) {
        super(table);
    }
}
