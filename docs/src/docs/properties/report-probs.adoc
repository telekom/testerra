...
| {screenshotter_active} | true | If true, screenshots will take automatically in general.
...
| {screencaster_active} | true | If true, a screencast is generated for failed tests.
