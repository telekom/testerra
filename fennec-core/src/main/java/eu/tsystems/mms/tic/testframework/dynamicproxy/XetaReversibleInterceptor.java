 ...
 */
public final class fennecReversibleInterceptor<T> extends ReversibleProxy<T> {
    /**
     * For fennec Users / Devs
     ...
     * myObject wrappedObject = new fennecReversibleInterceptor<myObject>(
     * object,
     ...
     */
    public fennecReversibleInterceptor(T object, IDefaultMethodWrapper wrapper) {
