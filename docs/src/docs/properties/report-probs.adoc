...
| {screencaster_active_on_failed} | true | If true, all screencasts for failed tests are fetchted and added to the report.
| {screencaster_active_on_success} | false | If true, all screencasts for successful tests are fetchted and added to the report.
