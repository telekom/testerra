 ...
 * 
 */
public class FennecMissingQCTestSetAnnotationException extends FennecSystemException {
     ...
     */
    public FennecMissingQCTestSetAnnotationException(Throwable cause) {
        super(cause);
    }
     ...
     */
    public FennecMissingQCTestSetAnnotationException(String string) {
        super(string);
    }
}
