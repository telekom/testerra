...
import eu.tsystems.mms.tic.testframework.testmanagement.QCTestset;
 ...
 * @author pele
 */
@QCTestset("Root\\Something\\This\\That\\Long\\Uberlong\\WTF\\deep")
public class ReportingWithQCPathTest extends AbstractTest {

    static {
        System.setProperty("qc.syncActive", "true");
    }
