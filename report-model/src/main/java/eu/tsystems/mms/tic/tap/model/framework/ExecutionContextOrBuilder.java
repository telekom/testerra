...
public interface ExecutionContextOrBuilder extends
   ...
   */
  java.util.List<eu.tsystems.mms.tic.tap.model.framework.ContextClip> 
      getExitPointsList();
  /**
   * <code>repeated .data.ContextClip exit_points = 4;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.ContextClip getExitPoints(int index);
  /**
   * <code>repeated .data.ContextClip exit_points = 4;</code>
   */
   ...
   * <code>repeated .data.ContextClip exit_points = 4;</code>
   */
  java.util.List<? extends eu.tsystems.mms.tic.tap.model.framework.ContextClipOrBuilder> 
      getExitPointsOrBuilderList();
  /**
   * <code>repeated .data.ContextClip exit_points = 4;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.ContextClipOrBuilder getExitPointsOrBuilder(
      int index);
   ...
   * <code>repeated .data.ContextClip failure_ascpects = 5;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.ContextClip getFailureAscpects(int index);
  /**
   * <code>repeated .data.ContextClip failure_ascpects = 5;</code>
   */
   ...
   * <code>repeated .data.ContextClip failure_ascpects = 5;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.ContextClipOrBuilder getFailureAscpectsOrBuilder(
      int index);
   ...
   */
  eu.tsystems.mms.tic.tap.model.framework.RunConfig getRunConfig();
  /**
   * <code>.data.RunConfig run_config = 7;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.RunConfigOrBuilder getRunConfigOrBuilder();
