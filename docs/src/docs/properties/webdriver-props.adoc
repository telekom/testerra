...
| {selenium_tracing_active} | false | Activates the Selenium tracing for remote webdriver, see https://www.selenium.dev/documentation/grid/advanced_features/observability/ for more details
|===
