...
public class UiElementShadowRootPage extends Page {
    ...
    public final UiElement shadowContent = shadowRootElement.find(By.xpath("//*[@id='shadow-content']"));
    ...
    public void assertInputText(final String expectedText) {
        shadowContentInput.assertThat().value().isContaining(expectedText);
    }

    public void assertShadowRootVisibility() {
        // shadow root is never displayed but present
        shadowRootElement.assertThat().present(true);

        // sub elements from shadow root are displayed
        shadowContent.assertThat().displayed(true);
//        shadowContentInput.assertThat().displayed(true);
        shadowContentParagraph.assertThat().displayed(true);
    }
}
