 ...
 * 
 */
public class fennecTestTable extends fennecTableDefinitions {
     ...
     */
    public fennecTestTable(final String table) {
        super(table);
    }
    ...
    public static void setIdField(final String idField) {
        fennecTestTable.idField = idField;
    }
    ...
    public static void setFirstname(final String firstname) {
        fennecTestTable.firstname = firstname;
    }
    ...
    public static void setLastname(final String lastname) {
        fennecTestTable.lastname = lastname;
    }
    ...
    public static void setCreationTime(final String creationTime) {
        fennecTestTable.creationTime = creationTime;
    }
