...
public final class SystemTestsGroup {
    ...
    public static final String SYSTEMTESTSFILTER2 = "SYSTEMTESTSFILTER2";
    public static final String SYSTEMTESTSFILTER3 = "SYSTEMTESTSFILTER3";
    ...
    public static final String BEFORE_TEST_FAILED = "TEST";
    public static final String BEFORE_GROUPS_FAILED = "GROUPS";
    public static final String BEFORE_CLASS_FAILED = "CLASS";
    public static final String BEFORE_METHOD_FAILED = "METHOD";
