...
For managing the execution behaviour of tests in suites the following features are provided.

== Behaviour after failure
There are means to skip tests and avoid closing browser windows after failures.
