...
import eu.tsystems.mms.tic.testframework.report.pageobjetcs.dashboard.DashboardModuleClassBarChart;
import eu.tsystems.mms.tic.testframework.report.pageobjetcs.dashboard.DashboardModuleFailureCorridor;
import eu.tsystems.mms.tic.testframework.report.pageobjetcs.dashboard.DashboardModuleHistoryAreaChart;
import eu.tsystems.mms.tic.testframework.report.pageobjetcs.dashboard.DashboardModuleInformationCorridor;
import eu.tsystems.mms.tic.testframework.report.pageobjetcs.dashboard.DashboardModuleMethodChart;
import eu.tsystems.mms.tic.testframework.report.pageobjetcs.dashboard.DashboardModuleTestResultNumberBreakdown;
import eu.tsystems.mms.tic.testframework.report.pageobjetcs.dashboard.DashboardModuleTestResultPieChart;
