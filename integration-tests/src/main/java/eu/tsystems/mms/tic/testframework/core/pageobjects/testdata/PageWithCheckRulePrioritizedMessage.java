 ...
 * @author mgn
 */
public class PageWithCheckRulePrioritizedMessage extends Page {

    @Check(prioritizedErrorMessage = "myMessage")
     ...
     * @param driver .
     */
    public PageWithCheckRulePrioritizedMessage(WebDriver driver) {
        super(driver);
    }
