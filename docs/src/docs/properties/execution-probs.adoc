...
| {watchdog_enable} | true | Enables/Disables the `WebDriverWatchDog`.
...
| {failure_corridor_active} |   false | Activate the failure corridor.
...
| {jvm_monitor_enabled} | true | Activate the JVMMonitor.
