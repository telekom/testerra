...
=== Logging
If you're on Gradle the logging of testerra should work out of the box. But if you're on Maven you MUST add the following SLF4J-dependency to your `pom.xml`.
