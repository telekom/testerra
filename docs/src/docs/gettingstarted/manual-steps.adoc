...
NOTE: Comming soon: Testerra will be available at MavenCentral.
...
dependencies {
    compile 'eu.tsystems.mms.tic.testerra:driver-ui-desktop:{revnumber}'
    compile 'eu.tsystems.mms.tic.testerra:report-ng:{revnumber}'
}
----
