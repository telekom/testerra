...
public class TimingsPage extends AbstractReportPage {
    ...
    @Check
    private GuiElement headLine = mainFrame.getSubElement(By.xpath("//h5[text()='Timings']"));
    ...
    public void assertPageIsDisplayedCorrectly(){
        GuiElement barChartNumberOfActionTypes = mainFrame.getSubElement(By.id("bars"));
        GuiElement dotplotValuesPerActionType = mainFrame.getSubElement(By.id("points"));
