 ...
 * @author pele
 */
public class ReportingConfigMethodsFail1Test extends AbstractTest {
    ...
    @BeforeMethod
    public void setUp2(Method method) throws Exception {
    ...
    @Test(dependsOnMethods = "testT01Passed")
    public void testT02Passed() {

    }

    @Test
    @SupportMethod
    public void testT03Passed() {
