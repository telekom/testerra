...
For every UiElement you need an implementation of the `UiElementFinder` interface (like a `Page`) and a locator (https://seleniumhq.github.io/selenium/docs/api/java/org/openqa/selenium/By.html[Selenium docs]).
