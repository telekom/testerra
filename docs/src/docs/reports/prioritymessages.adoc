...
In case you would like to some have some log messages displayed on a prominent place in the test details page, you can use priority messages like this:
...
The priority message is displayed on in the priority message panel on the right beside the test pie chart:
