...
public interface PTestStepActionOrBuilder extends
   ...
   */
  java.util.List<eu.tsystems.mms.tic.tap.model.framework.PClickPathEvent> 
      getClickpathEventsList();
  /**
   * <code>repeated .data.PClickPathEvent clickpath_events = 5;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.PClickPathEvent getClickpathEvents(int index);
  /**
   * <code>repeated .data.PClickPathEvent clickpath_events = 5;</code>
   */
   ...
   * <code>repeated .data.PClickPathEvent clickpath_events = 5;</code>
   */
  java.util.List<? extends eu.tsystems.mms.tic.tap.model.framework.PClickPathEventOrBuilder> 
      getClickpathEventsOrBuilderList();
  /**
   * <code>repeated .data.PClickPathEvent clickpath_events = 5;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.PClickPathEventOrBuilder getClickpathEventsOrBuilder(
      int index);
}
