 ...
 * @author pele
 */
public class fennecTestFailureException extends RuntimeException {
     ...
     */
    public fennecTestFailureException(final String message) {
        super(message);
    }
     ...
     */
    public fennecTestFailureException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     * @param cause The Throwable of the exception.
     */
    public fennecTestFailureException(final Throwable cause) {
        super(cause);
    }
}
