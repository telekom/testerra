...
The test class and test methods can be marked by several provided Annotations, which are described in the following paragraphs and in <<#Fails, @Fails>>, <<#Retry, @Retry>> and <<#NoRetry, @NoRetry>>
