...
public interface MethodContextOrBuilder extends
   ...
   */
  eu.tsystems.mms.tic.tap.model.framework.MethodType getMethodType();
   ...
   */
  eu.tsystems.mms.tic.tap.model.framework.FailureCorridorValue getFailureCorridorValue();
   ...
   */
  java.util.List<eu.tsystems.mms.tic.tap.model.framework.ErrorContext> 
      getNonFunctionalInfoList();
  /**
   * <code>repeated .data.ErrorContext non_functional_info = 17;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.ErrorContext getNonFunctionalInfo(int index);
  /**
   * <code>repeated .data.ErrorContext non_functional_info = 17;</code>
   */
   ...
   * <code>repeated .data.ErrorContext non_functional_info = 17;</code>
   */
  java.util.List<? extends eu.tsystems.mms.tic.tap.model.framework.ErrorContextOrBuilder> 
      getNonFunctionalInfoOrBuilderList();
  /**
   * <code>repeated .data.ErrorContext non_functional_info = 17;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.ErrorContextOrBuilder getNonFunctionalInfoOrBuilder(
      int index);
   ...
   * <code>repeated .data.ErrorContext collected_assertion = 18;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.ErrorContext getCollectedAssertion(int index);
  /**
   * <code>repeated .data.ErrorContext collected_assertion = 18;</code>
   */
   ...
   * <code>repeated .data.ErrorContext collected_assertion = 18;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.ErrorContextOrBuilder getCollectedAssertionOrBuilder(
      int index);
   ...
   */
  eu.tsystems.mms.tic.tap.model.framework.ErrorContext getErrorContext();
  /**
   * <code>.data.ErrorContext error_context = 25;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.ErrorContextOrBuilder getErrorContextOrBuilder();

  /**
   * <code>repeated .data.PTestStep test_steps = 26;</code>
   */
  java.util.List<eu.tsystems.mms.tic.tap.model.framework.PTestStep> 
      getTestStepsList();
  /**
   * <code>repeated .data.PTestStep test_steps = 26;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.PTestStep getTestSteps(int index);
  /**
   * <code>repeated .data.PTestStep test_steps = 26;</code>
   */
   ...
   * <code>repeated .data.PTestStep test_steps = 26;</code>
   */
  java.util.List<? extends eu.tsystems.mms.tic.tap.model.framework.PTestStepOrBuilder> 
      getTestStepsOrBuilderList();
  /**
   * <code>repeated .data.PTestStep test_steps = 26;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.PTestStepOrBuilder getTestStepsOrBuilder(
      int index);
