...
public class ExamplePage extends Page {
    ...
    @Check
    private UiElement moreInformationLink = find(By.partialLinkText("More information"));
...
The UiElement describes the elements like links, buttons, etc. on your page. Learn more about GuiElements in <<UiElements>>.
======
...
public class ExampleTest extends TesterraTest implements PageFactoryProvider {
    ...
    public void testT01_My_first_test() {
        ExamplePage examplePage = pageFactory.createPage(ExamplePage.class);
