...
public interface ErrorContextOrBuilder extends
   ...
   */
  eu.tsystems.mms.tic.tap.model.framework.StackTrace getStackTrace();
  /**
   * <code>.data.StackTrace stack_trace = 3;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.StackTraceOrBuilder getStackTraceOrBuilder();
   ...
   */
  eu.tsystems.mms.tic.tap.model.framework.ScriptSource getScriptSource();
  /**
   * <code>.data.ScriptSource script_source = 7;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.ScriptSourceOrBuilder getScriptSourceOrBuilder();
   ...
   */
  eu.tsystems.mms.tic.tap.model.framework.ScriptSource getExecutionObjectSource();
  /**
   * <code>.data.ScriptSource execution_object_source = 8;</code>
   */
  eu.tsystems.mms.tic.tap.model.framework.ScriptSourceOrBuilder getExecutionObjectSourceOrBuilder();
}
