...
(function () {
  ...
  GitGraph.prototype.render = function () {
    ...
    if ( this.template.commit.message.display ) {
      //TODO HACK [fennec CHANGE HERE]
      unscaledResolution.x += 250;
      //TODO HACKEND
    }
  ...
  GitGraph.prototype.hover = function ( event ) {
    ...
    function showCommitTooltip ( commit ) {
      ...
      //TODO HACK [fennec CHANGE HERE]
      if(self.tooltip.innerHTML.length > 1) {
    ...
    self.applyCommits( event, function ( commit, isOverCommit ) {
      if ( isOverCommit ) {
        //TODO HACK [fennec-CHANGE HERE]
        if (self.template.commit.shouldDisplayTooltipsInCompactMode ) {
  ...
  Commit.prototype.render = function () {
    ...
    // Detail - TODO fennec HACK HERE
    if ( this.detail !== null ) {
      var left = 41;
      if(this.x > 0) {
        left = 16
      }
      this.detail.style.left = this.parent.canvas.offsetLeft + commitOffsetLeft + this.x + left + "px";
      this.detail.style.top = this.parent.canvas.offsetTop + this.y + 25 + "px";
